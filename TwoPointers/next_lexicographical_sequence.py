...
print(next_lexicographical_sequence("abc"))
print(next_lexicographical_sequence("acb"))
print(next_lexicographical_sequence("bca"))
print(next_lexicographical_sequence("cba"))
print(next_lexicographical_sequence("abc"))
print(next_lexicographical_sequence("acb"))
print(next_lexicographical_sequence("bca"))
print(next_lexicographical_sequence("cba"))