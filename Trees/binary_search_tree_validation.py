...
print(binary_search_tree_validation(TreeNode(2, TreeNode(1), TreeNode(3))))
print(binary_search_tree_validation(TreeNode(5, TreeNode(1, TreeNode(3), TreeNode(4)), TreeNode(6))))
print(binary_search_tree_validation(TreeNode(5, TreeNode(1, TreeNode(3), TreeNode(4)), TreeNode(6, TreeNode(7)))))