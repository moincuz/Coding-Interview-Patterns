...
print(lowest_common_ancestor(TreeNode(1, TreeNode(2, TreeNode(4), TreeNode(5)), TreeNode(3, TreeNode(6), TreeNode(7))), TreeNode(4), TreeNode(5)))
print(lowest_common_ancestor(TreeNode(1, TreeNode(2, TreeNode(4), TreeNode(5)), TreeNode(3, TreeNode(6), TreeNode(7))), TreeNode(4), TreeNode(6)))
print(lowest_common_ancestor(TreeNode(1, TreeNode(2, TreeNode(4), TreeNode(5)), TreeNode(3, TreeNode(6), TreeNode(7))), TreeNode(4), TreeNode(7)))